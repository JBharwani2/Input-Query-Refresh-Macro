...
Partial Public NotInheritable Class InputQueryRefresh
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _InputQueryRefresh As InputQueryRefresh
    ...
    Friend Shared Property InputQueryRefresh() As InputQueryRefresh
        Get
            Return _InputQueryRefresh
        End Get
        Set
            If (_InputQueryRefresh Is Nothing) Then
                _InputQueryRefresh = value
            Else
